    ...
    return (
        <div className=" max-w-screen-xl mx-auto my-8">
            <div className="text-center mb-2">
                <h1 className="text-4xl  text-[#6f42c1] font-bold">Be a member!</h1>
                <p className="text-lg">Get the most out of our Inventory Management System. Unlock the endless possibilities </p>
            </div>
            <div className="lg:grid lg:grid-cols-3 grid-cols-1 gap-8 lg:w-full w-3/4 mx-auto">
                ...
                <div className='lg:w-3/4 my-8' data-aos="zoom-in-up" data-aos-duration="1000">
                    ...
                    <div className='pl-4 bg-[#6f42c1] text-white py-4'>
